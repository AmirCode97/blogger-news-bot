# تست استخراج اخبار از سایت‌های جدید حقوق بشری (نسخه ۲ با سلکتورهای اصلاح شده)
import sys
sys.path.insert(0, '.')
...
def test_fetch(source_name, url):
    ...
    if 'iran-hrm' in url:
        selectors = {
            "articles": "article",
            "title": "h3.jeg_post_title a, h2 a, h3 a, h4 a",
            "link": "h3.jeg_post_title a, h2 a, h3 a, h4 a",
            "image": "img"
        }
    # برای IranHumanRights
        ...
        selectors = {
            "articles": "article",
            "title": "h1.post-head-title a, h1 a, h2 a",
            "link": "h1.post-head-title a, h1 a, h2 a",
            "image": "img"  
        }
