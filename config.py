...
- متن فارسی باید حداقل ۴-۵ پاراگراف کامل و مفصل باشد
...
===PERSIAN===
[متن بازنویسی شده کامل به فارسی - حداقل ۴ پاراگراف مفصل]

===ENGLISH===
[Unique English summary - minimum 2 detailed paragraphs, NOT a translation of the original]

===GERMAN===
[Einzigartige deutsche Zusammenfassung - mindestens 2 ausführliche Absätze]
